...
SCM scm_cl_mem_info               (SCM memobj,   SCM param_name);
...
SCM scm_cl_kernel_info            (SCM kernel,   SCM param_name);
SCM scm_cl_event_info             (SCM event,    SCM param_name);
SCM scm_cl_sampler_info           (SCM sampler,  SCM param_name);
SCM scm_cl_program_build_info     (SCM program,  SCM device, SCM param_name);
SCM scm_cl_work_group_info        (SCM kernel,   SCM device, SCM param_name);
SCM scm_cl_event_profiling_info   (SCM event,    SCM param_name);
...
SCM scm_cl_info (SCM any,      SCM param_name);
