...
SCM scm_from_cl_buffer        (cl_mem           buffer);
SCM scm_from_cl_image         (cl_mem           image);
SCM scm_from_cl_program       (cl_program       program);
SCM scm_from_cl_kernel        (cl_kernel        kernel, SCM args);
...
#define scm_to_cl_buffer_here(obj)        scm_to_cl_buffer        (obj, __func__);
#define scm_to_cl_image_here(obj)         scm_to_cl_image         (obj, __func__);
...
cl_mem           scm_to_cl_buffer        (SCM buffer,        const char *subr);
cl_mem           scm_to_cl_image         (SCM image,         const char *subr);
